...
import { handleSaveCompanyDetails, handleGenerateSite, handleSiteStatus, handleDomainCheck, uploadLogo, sessionMiddleware, handleTimesEdited, getBusinessSectors, formProgressRouter, db } from '../server/routes/auto-site';
    ...
    app.post('/api/signup', async (req, res, next) => {
        ...
        try {
            ...
            if (Array.isArray(existing) && existing.length > 0) {
                const existsEmail = existing.some((u) => u.email_id === email);
                const existsLogin = existing.some((u) => u.login_id === login_id);
