  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Absolutely. Our solutions are built to integrate with your existing systems, databases, and third‑party apps. We review your setup carefully and plan for smooth data migration and integration."
      }
    ]
  },
  {
...
export function FAQs() {
  ...
  // Apply page SEO and inject FAQ structured data
  useEffect(() => {
    const meta = routeSeo['/faqs'] || { title: 'FAQs | Manacle', description: 'Frequently asked questions about Manacle products and services.' };
    applySeo('/faqs', meta);
    try {
